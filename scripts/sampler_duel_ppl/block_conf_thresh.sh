#!/bin/bash
#SBATCH -J exact_ppl_bd3lm_block_conf_thresh    # Job name
...
BLOCK_SIZE=16
EVAL_BATCH_SIZE=1 # Set to one to better determine average number of model calls

# sampling_params=(0.03 0.04 0.05 0.1 0.5 0.7 0.8 0.98 0.99)
sampling_params=0.075
...
for k in "${sampling_params[@]}"; do
    ...
    srun python -u main.py \
        ...
        wandb.project=duel wandb.name=bd3lm-${data}-block_size${BLOCK_SIZE}_exact_ll_${k} \
        mode=duel_ppl \
