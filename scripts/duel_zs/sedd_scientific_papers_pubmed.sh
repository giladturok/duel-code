#!/bin/bash
#SBATCH -J duel_zs_sedd_scientific_papers_pubmed
...
#SBATCH --mem=64G
#SBATCH -t 150:00:00
#SBATCH --exclude=sun-compute-03,snavely-compute-02,kuleshov-compute-02
...
python -u main.py \
    ...
    mode=duel_ppl > $PWD/logs/sedd_scientific_papers_pubmed_block_size${BLOCK_SIZE}_exact_ll.log
