#!/bin/bash
#SBATCH -J genppl_bd3lm_uniform       # Job name
...
python -u main.py \
    ...
    wandb.project=duel +wandb.name=sampler-genppl-uniform \
    mode=sample_eval \
    ...
    sampling.logdir=$PWD/sample_logs/samples_bd3lm_len${LENGTH}_blocksize${BLOCK_SIZE}_uniform.txt